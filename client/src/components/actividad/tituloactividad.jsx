...
export default function TituloActividad({proporcional}) {
        ...
        <div style={{width: '100%', height: 'auto'}}>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
                <div className='d-flex justify-content-start' style={{width: '65%', height: 64 / proporcional}}>
                    <p style={{fontSize: 30 / proporcional, lineHeight: `${32 / proporcional}px`, color: 'black', marginBottom: 0, fontWeight: 700}}>
                ...
                <div className='d-flex justify-content-center' style={{width: '23%', height: 64 / proporcional}}>
                    <div className='' style={{width: 'auto', height: 'auto'}}>
                        ...
                        <div className='d-flex' style={{width: 'auto', height: 32 / proporcional}}>
                            <img className='rounded-circle' src={icono_facebook} 
                                style={{width: 32 / proporcional, height: 32 / proporcional, padding: 7 / proporcional, background: 'black', marginRight: 5 / proporcional}}/>
                            <img className='rounded-circle' src={icono_instagram} 
                                style={{width: 32 / proporcional, height: 32 / proporcional, padding: 7 / proporcional, background: 'black', marginRight: 5 / proporcional}}/>
                            <img className='rounded-circle' src={icono_twitter} 
                                style={{width: 32 / proporcional, height: 32 / proporcional, padding: 7 / proporcional, background: 'black', marginRight: 5 / proporcional}}/>
                            <img className='rounded-circle' src={icono_tiktok} 
                                style={{width: 32 / proporcional, height: 32 / proporcional, padding: 7 / proporcional, background: 'black', marginRight: 5 / proporcional}}/>
                            <img className='rounded-circle' src={icono_linkedin} 
                                style={{width: 32 / proporcional, height: 32 / proporcional, padding: 7 / proporcional, background: 'black'}}/>
                        </div>
                    </div>
                </div>
            </div>
