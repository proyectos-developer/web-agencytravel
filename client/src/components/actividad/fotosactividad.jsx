...
export default function FotosActividad({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                <div style={{width: '19%', height: 400 / proporcional, border: '1px solid #efefef'}}>
                ...
                <div className='position-relative' style={{width: '19%', height: 400 / proporcional, border: '1px solid #efefef'}}>
                    <div style={{width: '100%', height: '100%', background: '#bdbdbd'}}/>
