...
export default function Blog({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', paddingTop: 60 / proporcional, paddingBottom: 300 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional}}>
            ...
            <div style={{width: '100%', height: 'auto'}}>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
                    <CardBlogCell  proporcional={proporcional}/>
                </div>
