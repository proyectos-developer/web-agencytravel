...
import FormularioDatosPersonalesTablet from './formulariodatospersonalestablet.jsx'
import ResumenReservasTablet from './resumenreservastablet.jsx'

export default function ClienteReservarPanelTablet({proporcional}) {
            ...
            <div className='' style={{width: '100%', height: 'auto', paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional,
                    ...
                    <div style={{width: '90%', height: 'auto'}}>
                        {
                            paso_reservas === 1 ? (
                                <div style={{width: '100%', height: 'auto'}}>
                                    ...
                                    <FormularioDatosPersonalesTablet proporcional={proporcional}/>
                ...
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
                    <div style={{width: '90%', height: 'auto'}}>
                        ...
                        <ResumenReservasTablet proporcional={proporcional}/>
                    </div>
                </div>
            </div>
        </div>
