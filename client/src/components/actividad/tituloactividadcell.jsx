...
export default function TituloActividadTablet({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto'}}>
            <div className='d-flex justify-content-start' style={{width: '100%', height: 64 / proporcional, marginBottom: 10 / proporcional}}>
            ...
            <div className='' style={{width: 'auto', height: 'auto', marginBottom: 10 / proporcional}}>
            ...
            <div className='d-flex justify-content-center' style={{width: '100%', height: 22 / proporcional, marginBottom: 50 / proporcional}}>
