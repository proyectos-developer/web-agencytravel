...
export default function CardRecomendacionTablet({proporcional}) {

    const navigate = useNavigate()
    const [ver_mas, setVerMas] = useState (false)

    return (
        <div className='shadow rounded' style={{width: '90%', height: 'auto', padding: 30 / proporcional, background: '#efefef'}}>
