...
export default function CardOpinionTablet({proporcional}) {

    return (
        <div className='shadow rounded' style={{width: '48%', height: 'auto', padding: 30 / proporcional, background: '#efefef', border: '1px solid #bdbdbd'}}>
