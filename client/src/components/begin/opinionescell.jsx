...
import CardOpinionCell from './card/opinioncell.jsx'
import { useNavigate } from 'react-router-dom'

export default function OpinionesCell({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', paddingTop: 50 / proporcional, paddingBottom: 50 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional}}>
            <div style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
                <p style={{fontSize: 30 / proporcional, lineHeight: `${32 / proporcional}px`, color: '#212121', cursor: 'default', fontWeight: 700, marginBottom: 0 / proporcional,
            ...
            <div style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                    <div style={{width: '90%', height: 'auto', paddingLeft: 20 / proporcional}}>
                ...
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                    <div style={{width: '90%', height: 'auto', paddingRight: 50 / proporcional}}>
            ...
            <div style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
                    <CardOpinionCell proporcional={propcellal}/>
                </div>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
                    <CardOpinionCell proporcional={propcellal}/>
                </div>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                    <button className='btn' style={{width: '90%', background: boton_opiniones ? 'white' : 'rgb(23, 43, 222)', height: 60 / proporcional, fontSize: 20 / proporcional, 
                        color: boton_opiniones ? 'rgb(23, 43, 222)' : 'white', fontWeight: 600, border: '1px solid rgb(23, 43, 222)'}}
