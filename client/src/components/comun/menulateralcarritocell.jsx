...
export default function MenuLateralCarritoCell({proporcional}) {
    ...
    return (
        <div className='position-fixed top-0 start-0 vh-100' style={{width: '100%', background: 'rgb(39, 39, 39, 0.6)'}}>
            <div className='position-absolute top-0 end-0 vh-100' style={{width: '80%', background: 'white', padding: 30 / proporcional}}>
                ...
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
                    <button className='btn rounded-pill' style={{width: '90%', height: 80 / proporcional, background: boton_carrito ? 'transparent' : 'rgb(23, 43, 222)', 
                ...
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                    <button className='btn rounded-pill' style={{width: '90%', height: 80 / proporcional, background: boton_continuar ? 'rgb(23, 43, 222)' : 'transparent', 
