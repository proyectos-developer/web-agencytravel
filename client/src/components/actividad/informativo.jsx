...
export default function Informativo({proporcional}) {
            ...
            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                <div style={{width: '90%', height: 'auto'}}>
                    <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                        <img src={tarjeta_visa} style={{width: '22%', height: '100%'}}/>
                        <img src={tarjeta_mastercard} style={{width: '22%', height: '100%'}}/>
                        <img src={tarjeta_americanexpress} style={{width: '22%', height: '100%'}}/>
                        <img src={tarjeta_dinersclub} style={{width: '22%', height: '100%'}}/>
                    </div>
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                        <img src={tarjeta_paypal} style={{width: '30%', height: '100%'}}/>
                    </div>
                </div>
            </div>
        </div>
