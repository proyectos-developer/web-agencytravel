...
export default function MenuSuperiorTablet({proporcional}) {
    ...
    return (
        <div className='position-relative' style={{width: '100%', height: 172 / proporcional, background: location.pathname.split ('/')[1] !== '' && location.pathname.split('/')[3] === undefined ? 'rgb(23, 43, 222)' : 'transparent', paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional}}>
            <div style={{width: '100%', height: 86 / proporcional}}>
                <div className='d-flex justify-content-end' style={{width: '100%', height: 86 / proporcional, paddingTop: 30 / proporcional, paddingBottom: 30 / proporcional}}>
                    <div style={{width: 26 / proporcional, height: 26 / proporcional, marginRight: 10 / proporcional}}>
                        <img src={location.pathname.split('/')[1] ? icono_search_white : icono_search_black} style={{width: 18 / proporcional, height: 18 / proporcional, margin: 4 / proporcional, cursor: 'pointer'}}
                            onClick={() => dispatch(set_screen_search(true))}/>
                    </div>
                    <div style={{width: 26 / proporcional, height: 26 / proporcional, marginRight: 10 / proporcional}}>
                        <img src={location.pathname.split('/')[1] ? icono_profile_white : icono_profile_black} style={{width: 18 / proporcional, height: 18 / proporcional, margin: 4 / proporcional, cursor: 'pointer'}}/>
                    </div>
            ...
            <div className='d-flex justify-content-between' style={{width: '100%', height: 86 / proporcional}}>
                <div className='d-flex justify-content-start' style={{width: '100%', height: 86 / proporcional}}>
                    <div style={{width: '50%', height: 86 / proporcional}}>
                        <div className='d-flex justify-content-start' style={{width: '100%', height: 86 / proporcional, paddingTop: 16 / proporcional, paddingBottom: 16 / proporcional}}>
                            <p style={{fontSize: 40 / proporcional, lineHeight: `${54 / proporcional}px`, marginBottom: 0, color: location.pathname.split('/')[1] ? 'white' : 'black', cursor: 'pointer', fontWeight: 700, 
                ...
                <div className='d-flex justify-content-end' style={{width: '100%', height: 86 / proporcional}}>
                    <div style={{width: 20 / proporcional, height: 20 / proporcional, marginTop: 33 / proporcional, marginBottom: 20 / proporcional}}>
                        <img src={location.pathname.split('/')[1] ? icono_menu_white : icono_menu_black} style={{witdth: 20 / proporcional, height: 20 / proporcional, cursor: 'pointer'}}
