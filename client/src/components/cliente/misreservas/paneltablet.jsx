...
import MisReservasTablet from './misreservastablet.jsx'

export default function ClienteMisReservasPanelTablet({proporcional}) {
        ...
        <div style={{width: '100%', height: 'auto', paddingTop: 120 / proporcional, paddingBottom: 120 / proporcional, paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional}}>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                ...
                <div style={{width: '70%', height: 'auto'}}>
                    <MisReservasTablet proporcional={proporcional}/>
                </div>
            </div>
        </div>
    )
