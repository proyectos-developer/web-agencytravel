...
import CardExperienciaTablet from './card/experienciatablet.jsx'

export default function ExperienciasTablet({proporcional}) {

    return (
        <div style={{width: '100%', height: 'auto', paddingTop: 60 / proporcional, paddingBottom: 60 / proporcional}}>
            <div style={{width: '100%', height: 'auto'}}>
                <div style={{width: '100%', height: 'auto', paddingLeft: 50 / proporcional, paddingRight: 50 / proporcional}}>
                        ...
                        <div className='carousel-inner' style={{width: '100%', height: 'auto'}}>
                            <div className='carousel-item active' style={{width: '100%', height: 'auto'}} data-bs-interval='3000'>
                                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                                    <CardExperienciaTablet proporcional={proporcional}/>
                                    <CardExperienciaTablet proporcional={proporcional}/>
                                </div>
                            </div>
